                      ...
                      window, parent)
{
    ...
    // connect(d->platformInterface, &DPlatformInterface::titleHeightChanged, this, &DPlatformTheme::titleHeightChanged);
    ...
    connect(d->platformInterface, &DPlatformInterface::iconThemeNameChanged, &DPlatformTheme::iconThemeNameChanged);
    connect(d->platformInterface, &DPlatformInterface::cursorThemeNameChanged, &DPlatformTheme::cursorThemeNameChanged);
    connect(d->platformInterface, &DPlatformInterface::fontPointSizeChanged, &DPlatformTheme::fontPointSizeChanged);
    connect(d->platformInterface, &DPlatformInterface::windowRadiusChanged, &DPlatformTheme::windowRadiusChanged);
    connect(d->platformInterface, &DPlatformInterface::scrollBarPolicyChanged, &DPlatformTheme::scrollBarPolicyChanged);
    
    QTimer *timer = new QTimer(this);
    connect(timer, &QTimer::timeout, this, [this](){
        activeColorChanged(QColor());
    });
    timer->start(2000);
}
