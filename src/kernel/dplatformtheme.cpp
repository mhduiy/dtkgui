                      ...
                      window, parent)
{
    ...
    if (DGuiApplicationHelper::testAttribute(DGuiApplicationHelper::IsXWindowPlatform)) {
        d->platformInterface = new DXCBPlatformInterface(0, parent);
    }
    #endif

    #ifndef DTK_DISABLE_TREELAND
        if (DGuiApplicationHelper::testAttribute(DGuiApplicationHelper::IsTreelandPlatform)) {
        d->platformInterface = new DTreelandPlatformInterface(parent);
        }
    #endif

    if (!d->platformInterface) {
        d->platformInterface = new DPlatformInterface(parent);
    }
...
#endif
    connect(d->platformInterface, &DPlatformInterface::cursorBlinkTimeChanged, this, &DPlatformTheme::cursorBlinkTimeChanged);
    connect(d->platformInterface, &DPlatformInterface::cursorBlinkTimeoutChanged, this, &DPlatformTheme::cursorBlinkTimeoutChanged);
    connect(d->platformInterface, &DPlatformInterface::cursorBlinkChanged, this, &DPlatformTheme::cursorBlinkChanged);
    connect(d->platformInterface, &DPlatformInterface::doubleClickDistanceChanged, this, &DPlatformTheme::doubleClickDistanceChanged);
    connect(d->platformInterface, &DPlatformInterface::doubleClickTimeChanged, this, &DPlatformTheme::doubleClickTimeChanged);
    connect(d->platformInterface, &DPlatformInterface::dndDragThresholdChanged, this, &DPlatformTheme::dndDragThresholdChanged);
    connect(d->platformInterface, &DPlatformInterface::themeNameChanged, this, &DPlatformTheme::themeNameChanged);
    connect(d->platformInterface, &DPlatformInterface::iconThemeNameChanged, this, &DPlatformTheme::iconThemeNameChanged);
    connect(d->platformInterface, &DPlatformInterface::soundThemeNameChanged, this, &DPlatformTheme::soundThemeNameChanged);
    connect(d->platformInterface, &DPlatformInterface::fontNameChanged, this, &DPlatformTheme::fontNameChanged);
    connect(d->platformInterface, &DPlatformInterface::monoFontNameChanged, this, &DPlatformTheme::monoFontNameChanged);
    connect(d->platformInterface, &DPlatformInterface::fontPointSizeChanged, this, &DPlatformTheme::fontPointSizeChanged);
    connect(d->platformInterface, &DPlatformInterface::gtkFontNameChanged, this, &DPlatformTheme::gtkFontNameChanged);
    connect(d->platformInterface, &DPlatformInterface::activeColorChanged, this, &DPlatformTheme::activeColorChanged);


    connect(d->platformInterface, &DPlatformInterface::activeColorChanged, this, [](){
        qWarning() << "88888888888";
    });
    
    
    connect(d->platformInterface, &DPlatformInterface::darkActiveColorChanged, this, &DPlatformTheme::darkActiveColorChanged);
    connect(d->platformInterface, &DPlatformInterface::paletteChanged, this, &DPlatformTheme::paletteChanged);
#if DTK_VERSION < DTK_VERSION_CHECK(6, 0, 0, 0)
    connect(d->platformInterface, &DPlatformInterface::windowChanged, this, &DPlatformTheme::windowChanged);
    connect(d->platformInterface, &DPlatformInterface::windowTextChanged, this, &DPlatformTheme::windowTextChanged);
    connect(d->platformInterface, &DPlatformInterface::baseChanged, this, &DPlatformTheme::baseChanged);
    connect(d->platformInterface, &DPlatformInterface::alternateBaseChanged, this, &DPlatformTheme::alternateBaseChanged);
    connect(d->platformInterface, &DPlatformInterface::toolTipBaseChanged, this, &DPlatformTheme::toolTipBaseChanged);
    connect(d->platformInterface, &DPlatformInterface::toolTipTextChanged, this, &DPlatformTheme::toolTipTextChanged);
    connect(d->platformInterface, &DPlatformInterface::textChanged, this, &DPlatformTheme::textChanged);
    connect(d->platformInterface, &DPlatformInterface::buttonChanged, this, &DPlatformTheme::buttonChanged);
    connect(d->platformInterface, &DPlatformInterface::buttonTextChanged, this, &DPlatformTheme::buttonTextChanged);
    connect(d->platformInterface, &DPlatformInterface::brightTextChanged, this, &DPlatformTheme::brightTextChanged);
    connect(d->platformInterface, &DPlatformInterface::lightChanged, this, &DPlatformTheme::lightChanged);
    connect(d->platformInterface, &DPlatformInterface::midlightChanged, this, &DPlatformTheme::midlightChanged);
    connect(d->platformInterface, &DPlatformInterface::darkChanged, this, &DPlatformTheme::darkChanged);
    connect(d->platformInterface, &DPlatformInterface::midChanged, this, &DPlatformTheme::midChanged);
    connect(d->platformInterface, &DPlatformInterface::shadowChanged, this, &DPlatformTheme::shadowChanged);
    connect(d->platformInterface, &DPlatformInterface::highlightChanged, this, &DPlatformTheme::highlightChanged);
    connect(d->platformInterface, &DPlatformInterface::highlightedTextChanged, this, &DPlatformTheme::highlightedTextChanged);
    connect(d->platformInterface, &DPlatformInterface::linkChanged, this, &DPlatformTheme::linkChanged);
    connect(d->platformInterface, &DPlatformInterface::linkVisitedChanged, this, &DPlatformTheme::linkVisitedChanged);
    connect(d->platformInterface, &DPlatformInterface::itemBackgroundChanged, this, &DPlatformTheme::itemBackgroundChanged);
    connect(d->platformInterface, &DPlatformInterface::textTitleChanged, this, &DPlatformTheme::textTitleChanged);
    connect(d->platformInterface, &DPlatformInterface::textTipsChanged, this, &DPlatformTheme::textTipsChanged);
    connect(d->platformInterface, &DPlatformInterface::textWarningChanged, this, &DPlatformTheme::textWarningChanged);
    connect(d->platformInterface, &DPlatformInterface::textLivelyChanged, this, &DPlatformTheme::textLivelyChanged);
    connect(d->platformInterface, &DPlatformInterface::lightLivelyChanged, this, &DPlatformTheme::lightLivelyChanged);
    connect(d->platformInterface, &DPlatformInterface::darkLivelyChanged, this, &DPlatformTheme::darkLivelyChanged);
    connect(d->platformInterface, &DPlatformInterface::frameBorderChanged, this, &DPlatformTheme::frameBorderChanged);
#endif
    connect(d->platformInterface, &DPlatformInterface::dotsPerInchChanged, this, &DPlatformTheme::dotsPerInchChanged);
    connect(d->platformInterface, &DPlatformInterface::windowRadiusChanged, this, &DPlatformTheme::windowRadiusChanged);
    connect(d->platformInterface, &DPlatformInterface::sizeModeChanged, this, &DPlatformTheme::sizeModeChanged);
    connect(d->platformInterface, &DPlatformInterface::scrollBarPolicyChanged, this, &DPlatformTheme::scrollBarPolicyChanged);
}
