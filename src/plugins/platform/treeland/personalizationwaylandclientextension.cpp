...
PersonalizationWindowContext::PersonalizationWindowContext(struct ::treeland_personalization_window_context_v1 *context, DTreelandPlatformInterface *interface)
...
{
    // treeland侧 无法存储浮点数，约定 font_size 为 10 倍的 pointSize
