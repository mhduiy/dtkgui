...
public:
    ...
    bool setEnabledNoTitlebarForWindow(QWindow *window, bool enable) override;
    void setEnableBlurWindowForWindow(QWindow *window, bool enable) override;
...
private:
    QScopedPointer<PersonalizationManager> m_manager;
