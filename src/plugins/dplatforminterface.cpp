...
void DPlatformInterface::setActiveColor(const QColor &color)
{

}


int DPlatformInterface::titleHeight() const
{

}

void DPlatformInterface::setTitleHeight(const int titleHeight)
{
...
void DPlatformInterface::setFontSize(const qreal fontSize)
{
...
void DPlatformInterface::setScrollBarPolicy(const int scrollBarPolicy)
{
